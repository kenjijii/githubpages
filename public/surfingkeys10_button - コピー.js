...
mapkey('tr', 'select or word', async function () {
 ...
 if (selection != '') {
  ...
  div.textContent = reWord.translations[0].text;
  selection.anchorNode.parentElement.append(div);
 };
});
vunmap('q');
vunmap('t');
...
const { translated, splited } = transSplitArray('Hello World This Is A Test');
...
function createControlButtons() {
 ...
 stopButton.textContent = 'justdoit';
...
function doit() {
 ...
 const { translated, splited } = transSplitArray(text);
 createControlButtons();
